...
CInfo::CInfo(void) {
	...
	this->deviceInfo				= new ST_DEVICE_INFO;
...
const ST_DEVICE_INFO  CInfo::getDeviceInfo(void) { this->refreshTimeStamp(); return *this->deviceInfo; }
...
void CInfo::setDeviceInfo(ST_DEVICE_INFO& _info) { *this->deviceInfo			  = _info; }
